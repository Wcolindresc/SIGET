// k6/concurrencia-reservas.js — Complemento de CP-10 / RF-05
...
export default function () {
  ...
  const body = JSON.stringify({
    equipoId: __ENV.EQUIPO_ID,
    fechaInicio: inicio.toISOString(),
    fechaFin: fin.toISOString(),
    motivo: 'Prueba de concurrencia k6',
  });
  ...
  const respuestas = http.batch(
    Array.from({ length: 10 }, () => ['POST', `${BASE}/reservas`, body, params])
  );
  ...
  check(creadas, {
    'RF-05: solo 1 reserva creada': (n) => n === 1,
  });
}
